...
class LearningObjectivesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->create('food_and_drink', 'easy','en','fi','vk','images/food_and_drink/apples.jpg', null);
