...
class LearningObjectivesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->create("number","easy","One","Yksi","Yksi","images/easy/1.jpg","voices/easy/40.mp3");
        $this->create("number","easy","Two","Kaksi","Kakši","images/easy/2.jpg","voices/easy/41.mp3");
        $this->create("number","easy","Three","Kolme","Kolme","images/easy/3.jpg","voices/easy/42.mp3");
        $this->create("number","easy","Four","Neljä","Nellä","images/easy/4.jpg","voices/easy/43.mp3");
        $this->create("number","easy","Five","Viisi","Viisi","images/easy/5.jpg","voices/easy/44.mp3");
        $this->create("number","easy","Six","Kuusi","Kuuši","images/easy/6.jpg","voices/easy/45.mp3");
        $this->create("number","easy","Seven","Seitsemän","Šeiččemen","images/easy/7.jpg","voices/easy/46.mp3");
        $this->create("number","easy","Eight","Kahdeksan","Kahekšan","images/easy/8.jpg","voices/easy/47.mp3");
        $this->create("number","easy","Nine","Yhdeksän","Yhekšän","images/easy/9.jpg","voices/easy/48.mp3");
        $this->create("number","easy","Ten","Kymmenen","Kymmenen","images/easy/10.jpg","voices/easy/49.mp3");

        $this->create("days_and_months","easy","Monday","Maanantai","Enšiarki","images/easy/Monday.jpg","voices/easy/50.mp3");
        $this->create("days_and_months","easy","Tuesday","Tiistai","Toiniarki","images/easy/Tuesday.jpg","voices/easy/51.mp3");
        $this->create("days_and_months","easy","Wednesday","Keskiviikko","Serota","images/easy/Wednesday.jpg","voices/easy/52.mp3");
        $this->create("days_and_months","easy","Thursday","Torstai","Nelläšpäivä","images/easy/Thursday.jpg","voices/easy/53.mp3");
        $this->create("days_and_months","easy","Friday","Perjantai","Piätinččä","images/easy/Friday.jpg","voices/easy/54.mp3");
        $this->create("days_and_months","easy","Saturday","Lauantai","Šuovatta","images/easy/Saturday.jpg","voices/easy/55.mp3");
        $this->create("days_and_months","easy","Sunday","Sunnuntai","Pyhäpäivä","images/easy/Sunday.jpg","voices/easy/56.mp3");
        $this->create("days_and_months","easy","Week","Viikko","Netäli","images/easy/Week.jpg","voices/easy/57.mp3");
        $this->create("days_and_months","easy","January","Tammikuu","Pakkaiskuu","images/easy/January.jpg","voices/easy/58.mp3");
        $this->create("days_and_months","easy","February","Helmikuu","Tuiskukuu","images/easy/February.jpg","voices/easy/59.mp3");
        $this->create("days_and_months","easy","March","Maaliskuu","Kevätkuu","images/easy/March.jpg","voices/easy/60.mp3");
        $this->create("days_and_months","easy","April","Huhtikuu","Šulakuu","images/easy/April.jpg","voices/easy/61.mp3");
        $this->create("days_and_months","easy","May","Saattaa","Oraškuu","images/easy/May.jpg","voices/easy/62.mp3");
        $this->create("days_and_months","easy","June","Kesäkuu","Kešäkuu","images/easy/June.jpg","voices/easy/63.mp3");
        $this->create("days_and_months","easy","July","Heinäkuu","Heinäkuu","images/easy/July.jpg","voices/easy/64.mp3");
        $this->create("days_and_months","easy","August","Elokuu","Elokuu","images/easy/August.jpg","voices/easy/65.mp3");
        $this->create("days_and_months","easy","September","Syyskuu","Šyyškuu","images/easy/September.jpg","voices/easy/66.mp3");
        $this->create("days_and_months","easy","October","Lokakuu","Šajekuu","images/easy/October.jpg","voices/easy/67.mp3");
        $this->create("days_and_months","easy","November","Marraskuu","Pimiekuu","images/easy/November.jpg","voices/easy/68.mp3");
        $this->create("days_and_months","easy","December","Joulukuu","Talvikuu","images/easy/December.jpg","voices/easy/69.mp3");
        ...
        $this->create("clothing","medium","I am wearing shoes","Minulla on kengät jalassa","Miula on kenkät jalašša",null,"voices/medium/11.mp3");
        ...
        $this->create("clothing","medium","He has black trousers","Hänellä on mustat housut","Hänellä on muššat pukšut",null,"voices/medium/13.mp3");
        ...
        $this->create("clothing","medium","His trousers are old","Hänen housut ovat vanhat","Hänen pukšut ollah vanhat",null,"voices/medium/19.mp3");
        ...
        $this->create("number","medium","It is six o'clock in the morning","Kello on kuusi aamulla","Kello on kuuši huomenešta",null,"voices/medium/56.mp3");
        $this->create("number","medium","It is three o'clock in the night","Kello on kolme yöllä","Kello on kolme yötä",null,"voices/medium/57.mp3");
        $this->create("number","medium","It is four o'clock in the afternoon","Kello on neljä iltapäivällä","Kello on nellä iltapäivyä",null,"voices/medium/58.mp3");
        $this->create("number","medium","A course will start at nine in the morning","Kurssi alkaa yhdeksältä aamulla","Kuršši alkau yhekšältä huomenekšella",null,"voices/medium/59.mp3");
        $this->create("number","medium","We will see tomorrow evening at eight","Näemme huomenna kahdeksalta illalla","Näkeyvymmä huomena kahekšalta illalla",null,"voices/medium/60.mp3");
        $this->create("number","medium","It is seven o'clock in the evening","Kello on seitsemän illalla","Kello on šeiččemen iltua",null,"voices/medium/61.mp3");
        $this->create("number","medium","At what time the course starts?","Mihin aikaan kurssi alkaa?","Mih aikah kuršši alkau?",null,"voices/medium/62.mp3");
        $this->create("number","medium","When the course starts?","Milloin kurssi alkaa?","Konša kuršši alkau? ",null,"voices/medium/63.mp3");
        $this->create("number","medium","It costs one hundred rubles","Se maksaa sata ruplaa","Se makšau šata rupl´ua",null,"voices/medium/64.mp3");
        $this->create("number","medium","It costs two hundres rubles","Se maksaa kaksisataa ruplaa","Se makšau kakšišatua rupl´ua",null,"voices/medium/65.mp3");
        $this->create("number","medium","Tomorrow morning he arise at six","Huomenaamulla hän nousee kuudelta","Huomenekšella hiän noušou kuuvvelta",null,"voices/medium/66.mp3");
        $this->create("number","medium","He leaves from home at one o'clock","Hän lähtee kotoa yhdeltä","Hiän lähtöy koista yheltä",null,"voices/medium/67.mp3");

        $this->create("days_and_months","medium","Today is monday","Tänään on maanantai","Tänäpiänä on enšiarki",null,"voices/medium/68.mp3");
        $this->create("days_and_months","medium","Tomorrow is tuesday","Huomenna on tiistai","Huomena on toiniarki",null,"voices/medium/69.mp3");
        $this->create("days_and_months","medium","Yesterday was sunday","Eilen oli sunnuntai","Eklein oli pyhäpäivä",null,"voices/medium/70.mp3");
        $this->create("days_and_months","medium","The day before yesterday was saturday","Toissapäivänä oli lauantai","Toissapiänä oli šuovatta",null,"voices/medium/71.mp3");
        $this->create("days_and_months","medium","The day after tomorrow is thursday","Ylihuomenna on torstai","Ylihuomena on nelläšpäivä",null,"voices/medium/72.mp3");
        $this->create("days_and_months","medium","What day of the week today is?","Mikä viikonpäivä tänään on?","Mi netälinpäivä tänäpiänä on?",null,"voices/medium/73.mp3");
        $this->create("days_and_months","medium","It was cloudy weather in the last week","Viime viikolla oli pilvinen sää","Männä netälillä oli pilvisä siä ",null,"voices/medium/74.mp3");
        $this->create("days_and_months","medium","In which year you have been born?","Minä vuonna olet syntynyt?","Minä vuotena olet šyntyn?",null,"voices/medium/75.mp3");
        $this->create("days_and_months","medium","What is the first month in the year?","Mikä on vuoden ensimmäinen kuukausi?","Mi on vuuvven enšimmäini kuukauši?",null,"voices/medium/76.mp3");
        $this->create("days_and_months","medium","The first month in the year is January","Vuoden ensimmäinen kuukausi on tammikuu","Vuuvven enšimmäini kuukauši on pakkaiskuu",null,"voices/medium/77.mp3");
        $this->create("days_and_months","medium","When the sun starts to shine warmy?","Milloin aurinko alkaa paistaa lämpimästi?","Konša päivyä alkau paistua lämpimäšti? ",null,"voices/medium/78.mp3");
        $this->create("days_and_months","medium","In which month snow is melting?","Missä kuussa lumi sulaa?","Missä kuušša lumi šulau?",null,"voices/medium/79.mp3");
        ...
        $this->create("number","hard","One and two is together three","Yksi ja kaksi on yhteenlaskettuna kolme","Yksi ta kakši on yhteh lašettuna kolme",null,"voices/hard/61.mp3");
        $this->create("number","hard","Four and six is together ten","Neljä ja kuusi on yhteenlaskettuna kymmenen","Nellä ta kuuši on yhteh lašettuna kymmenen",null,"voices/hard/62.mp3");
        $this->create("number","hard","Nine and twelve is together twentyone","Yhdeksän ja kaksitoista on yhteenlaskettuna kaksikymmentäyksi","Yhekšän ta kakšitoista on yhteh lašettuna kakšikymmentäyksi",null,"voices/hard/63.mp3");
        $this->create("number","hard","Three and five is together eight","Kolme ja viisi on yhteenlaskettuna kahdeksan","Kolme ta viisi on yhteh lašettuna kahekšan",null,"voices/hard/64.mp3");
        $this->create("number","hard","Seven and seven is together fourteen","Seitsemän ja seitsemän on yhteenlaskettuna neljätoista","Šeiččemen ta šeiččemen on yhteh lašettuna nellätoista",null,"voices/hard/65.mp3");
        $this->create("number","hard","One and hundred is together one hundred and one","Yksi ja sata on yhteenlaskettuna satayksi","Yksi ta šata on yhteh lašettuna šatayksi",null,"voices/hard/66.mp3");
        $this->create("number","hard","Two hundred and eight hundred is together one thousand","Kaksi sataa ja kahdeksan sataa on yhteenlaskettuna tuhat","Kakšišatua ta kahekšanšatua on yhteh lašettuna tuhat",null,"voices/hard/67.mp3");
        $this->create("number","hard","I am 25 years old","Minä olen 25-vuotias","Mie olen 25-vuotini",null,"voices/hard/68.mp3");
        $this->create("number","hard","How old are you?","Kuinka vanha sinä olet?","Kuin vanha šie olet?",null,"voices/hard/69.mp3");
        $this->create("number","hard","I am sixty two years old","Minä olen kuusikymmentäkaksivuotias","Mie ole kuušikymmentäkakšivuotini",null,"voices/hard/70.mp3");
        $this->create("number","hard","How many years you have?","Kuinka monta vuotta sinä olet?","Kuin monta vuotta šiula on?",null,"voices/hard/71.mp3");
        $this->create("number","hard","Friday is the fifth day in the week","Perjantai on viides viikonpäivä","Piätinččä on viiješ netälinpäivä",null,"voices/hard/72.mp3");

        $this->create("days_and_months","hard","Monday is the first day of the week","Maanantai on ensimmäinen viikonpäivä","Enšiarki on enšimmäini netälinpäivä",null,"voices/hard/73.mp3");
        $this->create("days_and_months","hard","Tuesday is the second day of the week","Tiistai on toinen viikonpäivä","Toiniarki on toini netälinpäivä",null,"voices/hard/74.mp3");
        $this->create("days_and_months","hard","Wednesday is the third day of the week","Keskiviikko on kolmas viikonpäivä","Serota on kolmaš netälinpäivä",null,"voices/hard/75.mp3");
        $this->create("days_and_months","hard","Thursday is the fourth day of the week","Torstai on neljäs viikonpäivä","Nelläšpäivä on nelläš netälinpäivä",null,"voices/hard/76.mp3");
        $this->create("days_and_months","hard","Friday is the fifth day of the week","Perjantai on viides viikonpäivä","Piätinččä on viijes netälinpäivä",null,"voices/hard/77.mp3");
        $this->create("days_and_months","hard","Saturday is the sixth day of the week","Lauantai on kuudes viikonpäivä","Šuovatta on kuuvveš netälinpäivä",null,"voices/hard/78.mp3");
        $this->create("days_and_months","hard","Sunday is the seventh day of the week","Sunnuntai on seitsemäs viikonpäivä","Pyhäpäivä on šeiččemeš  netälinpäivä",null,"voices/hard/79.mp3");
        $this->create("days_and_months","hard","January is the first month of the year","Tammikuu on vuoden ensimmäinen kuukausi","Pakkaiskuu on vuuvven enšimmäini kuukauši",null,"voices/hard/80.mp3");
        $this->create("days_and_months","hard","February is the second month of the year","Helmikuu on vuoden toinen kuukausi","Tuiskukuu on vuuvven toini kuukauši",null,"voices/hard/81.mp3");
        $this->create("days_and_months","hard","April is the fourth month of the year","Huhtikuu on vuoden neljäs kuukausi","Šulakuu on vuuvven nelläš kuukauši",null,"voices/hard/82.mp3");
        $this->create("days_and_months","hard","May is the fifth month of the year","Toukokuu on vuoden viides kuukausi","Oraškuu on vuuvven viijes kuukauši",null,"voices/hard/83.mp3");
        $this->create("days_and_months","hard","Snow will melt on next month","Lumi sulaa ensi kuussa","Enšikuušša lumi šulau",null,"voices/hard/84.mp3");
    }
